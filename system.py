...
# --------------------------------------------------
def login_screen():
    st.markdown("<h1 style='text-align: center; color: #1E90FF;'>🌟 試験用</h1>", unsafe_allow_html=True)
...
def main():
    ...
    <div style="background-color:#1E90FF;padding:10px;border-radius:10px;margin-bottom:20px;">
        <h2 style="color:white;text-align:center;margin:0;">🌟 試験用 <span style="font-size:0.5em;background-color:white;color:#1E90FF;padding:2px 8px;border-radius:5px;">{st.session_state['username']} モード</span></h2>
    </div>
