...
# ページの基本設定
st.set_page_config(page_title="学習塾管理システム", layout="wide")
...
# --------------------------------------------------
def login_screen():
    st.markdown("<h1 style='text-align: center; color: #1E90FF;'>🌟 〇〇塾 統合管理システム</h1>", unsafe_allow_html=True)
...
def main():
    ...
    <div style="background-color:#1E90FF;padding:10px;border-radius:10px;margin-bottom:20px;">
        <h2 style="color:white;text-align:center;margin:0;">🌟 〇〇塾 統合管理システム <span style="font-size:0.5em;background-color:white;color:#1E90FF;padding:2px 8px;border-radius:5px;">{st.session_state['username']} モード</span></h2>
    </div>
