...
def render_quiz_maker_page():
    ...
    exclude_list = ["キクタン8問", "キクタン16問", "キクタン32問", "キクタン50問", "キクタン8問(東)", "キクタン16問(東)", "キクタン32問(東)", "キクタン50問(東)", "WordCup20問", "WordCup100問", "WordCup200問", "iワーク中1(数学)", "iワーク中2(数学)", "iワーク中3(数学)", "iワーク中1(国語)", "iワーク中2(国語)", "iワーク中3(国語)", "iワーク中1(理科)", "iワーク中2(理科)", "iワーク中3(理科)", "iワーク中1(社会)", "iワーク中2(社会)", "iワーク中3(社会)", "iワーク中1(英語)", "iワーク中2(英語)", "iワーク中3(英語)"]
