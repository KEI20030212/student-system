...
def render_quiz_maker_page():
    ...
    exclude_list = ["キクタン8問", "キクタン16問", "キクタン32問", "キクタン50問", "キクタン8問(東)", "キクタン16問(東)", "キクタン32問(東)", "キクタン50問(東)", "WordCup20問", "WordCup100問", "WordCup200問", "英単語ターゲット1900(100問)", "英単語ターゲット1900(200問)", "英単語ターゲット1900(20問)", "iワーク＋中1(数学)(東書)単元確認テスト", "iワーク＋中2(数学)(東書)単元確認テスト", "iワーク＋中3(数学)(東書)単元確認テスト", "iワーク＋中1(国語)(光村)完成テスト", "iワーク＋中2(国語)(光村)完成テスト", "iワーク＋中3(国語)(光村)完成テスト", "iワーク＋中1(理科)(啓林)単元確認テスト", "iワーク＋中2(理科)(啓林)単元確認テスト", "iワーク＋中3(理科)(啓林)単元確認テスト", "iワーク＋歴史Ⅰ(東書)単元確認テスト", "iワーク＋歴史Ⅱ(東書)単元確認テスト", "iワーク＋地理Ⅱ(東書)単元確認テスト", "iワーク＋地理Ⅰ(東書)単元確認テスト", "iワーク＋中1(英語)(東書)単元確認テスト", "iワーク＋中2(英語)(東書)単元確認テスト", "iワーク＋中3(英語)(東書)単元確認テスト", "iワーク中3英単語(東書)", "漢字ガイダンス小4", "漢字ガイダンス小5", "漢字ガイダンス小6", "計算トレーニング小4", "計算トレーニング小5", "計算トレーニング小6", "トレーニングノート中学漢字(読み書き)", "良問テスト(簡)中1", "良問テスト(難)中1", "良問テスト(簡)中2", "良問テスト(難)中2", "良問テスト(簡)中3", "良問テスト(難)中3"]
